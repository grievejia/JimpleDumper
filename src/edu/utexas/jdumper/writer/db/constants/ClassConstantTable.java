...
public class ClassConstantTable {
    private PreparedStatement insertStmt;

    private static final String TABLE_NAME = "classconstants";

    public ClassConstantTable(Connection connection) throws SQLException
    {
    ...
    public void insert(int id, String className) throws SQLException
    {
