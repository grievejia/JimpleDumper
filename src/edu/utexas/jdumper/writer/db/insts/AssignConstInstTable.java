...
public class AssignConstInstTable
{
    private PreparedStatement insertStmt;

    private static final String TABLE_NAME = "assignconstinsts";

    public AssignConstInstTable(Connection connection) throws SQLException
    {
