...
public class AssignCastInstTable
{
    private PreparedStatement insertStmt;

    private static final String TABLE_NAME = "assigncastinsts";

    public AssignCastInstTable(Connection connection) throws SQLException
    {
    ...
    public void insert(int id, int lhs, int rhs, int tid, int mid) throws SQLException
    {
        insertStmt.setInt(1, id);
        insertStmt.setInt(2, lhs);
        insertStmt.setInt(3, rhs);
        insertStmt.setInt(4, tid);
