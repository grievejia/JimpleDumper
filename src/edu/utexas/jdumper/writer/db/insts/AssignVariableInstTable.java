...
public class AssignVariableInstTable
{
    private PreparedStatement insertStmt;

    private static final String TABLE_NAME = "assignvarinsts";

    public AssignVariableInstTable(Connection connection) throws SQLException
    {
