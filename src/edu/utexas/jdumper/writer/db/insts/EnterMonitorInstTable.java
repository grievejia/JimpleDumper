...
public class EnterMonitorInstTable
{
    private PreparedStatement insertStmt;

    private static final String TABLE_NAME = "entermonitorinsts";

    public EnterMonitorInstTable(Connection connection) throws SQLException
    {
