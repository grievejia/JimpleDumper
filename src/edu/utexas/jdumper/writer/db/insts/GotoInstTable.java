...
public class GotoInstTable
{
    private PreparedStatement insertStmt;

    private static final String TABLE_NAME = "gotoinsts";

    public GotoInstTable(Connection connection) throws SQLException
    {
    ...
    public void insert(int id, int target, int mid) throws SQLException
    {
