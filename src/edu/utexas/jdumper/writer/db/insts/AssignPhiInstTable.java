...
public class AssignPhiInstTable
{
    private PreparedStatement insertStmt;

    private static final String TABLE_NAME = "assignphiinsts";

    public AssignPhiInstTable(Connection connection) throws SQLException
    {
    ...
    public void insert(int id, int lhs, int mid) throws SQLException
    {
